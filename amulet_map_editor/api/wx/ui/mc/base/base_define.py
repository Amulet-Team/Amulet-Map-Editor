...
class BaseDefine(wx.Panel, BaseMCVersion):
    ...
    def push(self) -> bool:
        if (
            ...
            self._version_picker.platform = self.platform
            self._version_picker.version_number = self.version_number
            self._version_picker.force_blockstate = self.force_blockstate
