...
ctypedef void (*GL_DRAW_ARRAYS_INSTANCED_BASE_INSTANCE)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance)
ctypedef void (*GL_DRAW_ELEMENTS_INSTANCED_BASE_INSTANCE)(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLuint baseinstance)
ctypedef void (*GL_DRAW_ELEMENTS_INSTANCED_BASE_VERTEX_BASE_INSTANCE)(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance)
ctypedef void (*GL_GET_INTERNALFORMATIV)(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params)
ctypedef void (*GL_GET_ACTIVE_ATOMIC_COUNTER_BUFFERIV)(GLuint program, GLuint bufferIndex, GLenum pname, GLint *params)
ctypedef void (*GL_BIND_IMAGE_TEXTURE)(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format)
ctypedef void (*GL_MEMORY_BARRIER)(GLbitfield barriers)
ctypedef void (*GL_TEX_STORAGE1D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width)
ctypedef void (*GL_TEX_STORAGE2D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height)
ctypedef void (*GL_TEX_STORAGE3D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth)
ctypedef void (*GL_DRAW_TRANSFORM_FEEDBACK_INSTANCED)(GLenum mode, GLuint id, GLsizei instancecount)
ctypedef void (*GL_DRAW_TRANSFORM_FEEDBACK_STREAM_INSTANCED)(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount)

cdef GL_DRAW_ARRAYS_INSTANCED_BASE_INSTANCE cglDrawArraysInstancedBaseInstance = NULL
cdef GL_DRAW_ELEMENTS_INSTANCED_BASE_INSTANCE cglDrawElementsInstancedBaseInstance = NULL
cdef GL_DRAW_ELEMENTS_INSTANCED_BASE_VERTEX_BASE_INSTANCE cglDrawElementsInstancedBaseVertexBaseInstance = NULL
cdef GL_GET_INTERNALFORMATIV cglGetInternalformativ = NULL
cdef GL_GET_ACTIVE_ATOMIC_COUNTER_BUFFERIV cglGetActiveAtomicCounterBufferiv = NULL
cdef GL_BIND_IMAGE_TEXTURE cglBindImageTexture = NULL
cdef GL_MEMORY_BARRIER cglMemoryBarrier = NULL
cdef GL_TEX_STORAGE1D cglTexStorage1D = NULL
cdef GL_TEX_STORAGE2D cglTexStorage2D = NULL
cdef GL_TEX_STORAGE3D cglTexStorage3D = NULL
cdef GL_DRAW_TRANSFORM_FEEDBACK_INSTANCED cglDrawTransformFeedbackInstanced = NULL
cdef GL_DRAW_TRANSFORM_FEEDBACK_STREAM_INSTANCED cglDrawTransformFeedbackStreamInstanced = NULL
...
cdef void GetglDrawArraysInstancedBaseInstance(GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance):
    ...
    cglDrawArraysInstancedBaseInstance = <GL_DRAW_ARRAYS_INSTANCED_BASE_INSTANCE>getFunction(b"glDrawArraysInstancedBaseInstance")
...
cdef void GetglDrawElementsInstancedBaseInstance(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLuint baseinstance):
    ...
    cglDrawElementsInstancedBaseInstance = <GL_DRAW_ELEMENTS_INSTANCED_BASE_INSTANCE>getFunction(b"glDrawElementsInstancedBaseInstance")
...
cdef void GetglDrawElementsInstancedBaseVertexBaseInstance(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance):
    ...
    cglDrawElementsInstancedBaseVertexBaseInstance = <GL_DRAW_ELEMENTS_INSTANCED_BASE_VERTEX_BASE_INSTANCE>getFunction(b"glDrawElementsInstancedBaseVertexBaseInstance")
...
cdef void GetglGetInternalformativ(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params):
    ...
    cglGetInternalformativ = <GL_GET_INTERNALFORMATIV>getFunction(b"glGetInternalformativ")
...
cdef void GetglGetActiveAtomicCounterBufferiv(GLuint program, GLuint bufferIndex, GLenum pname, GLint *params):
    ...
    cglGetActiveAtomicCounterBufferiv = <GL_GET_ACTIVE_ATOMIC_COUNTER_BUFFERIV>getFunction(b"glGetActiveAtomicCounterBufferiv")
...
cdef void GetglBindImageTexture(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format):
    ...
    cglBindImageTexture = <GL_BIND_IMAGE_TEXTURE>getFunction(b"glBindImageTexture")
...
cdef void GetglMemoryBarrier(GLbitfield barriers):
    ...
    cglMemoryBarrier = <GL_MEMORY_BARRIER>getFunction(b"glMemoryBarrier")
...
cdef void GetglTexStorage1D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width):
    ...
    cglTexStorage1D = <GL_TEX_STORAGE1D>getFunction(b"glTexStorage1D")
...
cdef void GetglTexStorage2D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height):
    ...
    cglTexStorage2D = <GL_TEX_STORAGE2D>getFunction(b"glTexStorage2D")
...
cdef void GetglTexStorage3D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth):
    ...
    cglTexStorage3D = <GL_TEX_STORAGE3D>getFunction(b"glTexStorage3D")
...
cdef void GetglDrawTransformFeedbackInstanced(GLenum mode, GLuint id, GLsizei instancecount):
    ...
    cglDrawTransformFeedbackInstanced = <GL_DRAW_TRANSFORM_FEEDBACK_INSTANCED>getFunction(b"glDrawTransformFeedbackInstanced")
...
cdef void GetglDrawTransformFeedbackStreamInstanced(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount):
    ...
    cglDrawTransformFeedbackStreamInstanced = <GL_DRAW_TRANSFORM_FEEDBACK_STREAM_INSTANCED>getFunction(b"glDrawTransformFeedbackStreamInstanced")
...
cpdef void glDrawArraysInstancedBaseInstance(GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance):
    cglDrawArraysInstancedBaseInstance(mode, first, count, instancecount, baseinstance)

cpdef void glDrawElementsInstancedBaseInstance(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLuint baseinstance):
    cglDrawElementsInstancedBaseInstance(mode, count, type, indices, instancecount, baseinstance)

cpdef void glDrawElementsInstancedBaseVertexBaseInstance(GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance):
    cglDrawElementsInstancedBaseVertexBaseInstance(mode, count, type, indices, instancecount, basevertex, baseinstance)

cpdef void glGetInternalformativ(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params):
    cglGetInternalformativ(target, internalformat, pname, count, params)

cpdef void glGetActiveAtomicCounterBufferiv(GLuint program, GLuint bufferIndex, GLenum pname, GLint *params):
    cglGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, params)

cpdef void glBindImageTexture(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format):
    cglBindImageTexture(unit, texture, level, layered, layer, access, format)

cpdef void glMemoryBarrier(GLbitfield barriers):
    cglMemoryBarrier(barriers)

cpdef void glTexStorage1D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width):
    cglTexStorage1D(target, levels, internalformat, width)

cpdef void glTexStorage2D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height):
    cglTexStorage2D(target, levels, internalformat, width, height)

cpdef void glTexStorage3D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth):
    cglTexStorage3D(target, levels, internalformat, width, height, depth)

cpdef void glDrawTransformFeedbackInstanced(GLenum mode, GLuint id, GLsizei instancecount):
    cglDrawTransformFeedbackInstanced(mode, id, instancecount)

cpdef void glDrawTransformFeedbackStreamInstanced(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount):
    cglDrawTransformFeedbackStreamInstanced(mode, id, stream, instancecount)
