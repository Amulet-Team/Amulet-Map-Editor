...
class AmuletMainMenu(wx.Panel, BasePageUI):
    def __init__(self, parent: wx.Window, open_world):
        ...
        self._open_world_button = wx.Button(self, label=lang.get("main_menu.open_world"), size=(400, 70))
        ...
        self._help_button = wx.Button(self, label=lang.get("main_menu.help"), size=(400, 70))
