...
class PlatformSelect(BaseSelect):
    def __init__(
        ...
        **kwargs
        ...
        self._platform_list: SimpleChoice = self._add_ui_element(
    ...
    def _set_platform(self, platform: str = None):
        ...
        if not self._allow_vanilla:
            platforms = [p for p in platforms if p == "universal"]
        self._platform_list.SetItems(platforms)
...
class VersionSelect(PlatformSelect):
    def __init__(
        ...
        **kwargs
        ...
        self._version_list: Optional[SimpleChoiceAny] = self._add_ui_element(
    ...
    def _set_version(self, version: Tuple[int, int, int] = None):
        ...
        if not self._allow_numerical:
            versions = [v for v in versions if v >= (1, 13, 0)]
        self._version_list.SetItems(versions)
...
class SubVersionSelect(VersionSelect):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(parent, translation_manager, platform, version, **kwargs)
        self._blockstate_button: Optional[wx.CheckBox] = self._add_ui_element(
            "Force Blockstate", wx.CheckBox
        )
...
class BlockSelect(SubVersionSelect):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            parent, translation_manager, platform, version, blockstate, **kwargs
        )
        self._namespace_list: Optional[SimpleChoice] = self._add_ui_element(
            "Namespace", SimpleChoice
        )
        self._base_name_list: Optional[SimpleChoice] = self._add_ui_element(
            "Base name", SimpleChoice
        )
    ...
    def _set_namespace(self, namespace: str = None):
        ...
        self._namespace_list.SetItems(namespaces)
    ...
    def _set_base_name(self, base_name: str = None):
        ...
        self._base_name_list.SetItems(base_names)
...
class BlockDefine(BlockSelect):
    def __init__(
        ...
        **kwargs
        ...
        self._properties_panel: wx.Panel = wx.Panel(
            self, wx.VERTICAL, style=properties_style
        )
        properties_sizer = wx.BoxSizer(wx.VERTICAL)
        self._properties_panel.SetSizer(properties_sizer)
        self._sizer.Add(
            self._properties_panel, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.BOTTOM, 5
        )
    ...
    def _add_property(
        self, property_name: str, property_values: List[str], default: str = None
    ):
        sizer = wx.BoxSizer(wx.HORIZONTAL)
    ...
    def _set_properties(self, properties: Dict[str, str] = None):
        ...
        specification = self._translation_manager.get_version(
            self.platform, self.version
        ).block.get_specification(self.namespace, self.base_name, self.force_blockstate)
