...
from amulet_map_editor.programs.edit.plugins.api.errors import OperationSilentAbort, OperationError
...
def copy(
    ...
    if selection:
        ...
        raise OperationError("At least one selection is required for the copy operation.")
