...
operation_options = {  # options is a dictionary where the key is the description shown to the user and the value describes how to build the UI
    ...
    "Bool input default": ["bool"],  # This will be a check box that takes the default value (unchecked)
    "Bool input False": ["bool", False],  # This will be a check box that starts unchecked
    ...
    "Int input 10": ["int", 10],  # This will be an integer input with starting value 10 (or whatever you put in the second slot)
    "Int input 10 bounded": ["int", 10, 0, 20],  # same as above but must be between the third and fourth values

    # float examples  https://wxpython.org/Phoenix/docs/html/wx.SpinCtrlDouble.html
    "Float input default": ["float"],  # This will be a float input with starting value 0.0
    "Float input 10": ["float", 10],  # This will be a float input with starting value 10.0 (or whatever you put in the second slot)
    "Float input 10 bounded": ["float", 10, 0, 20],  # same as above but must be between the third and fourth values

    # string input examples  https://wxpython.org/Phoenix/docs/html/wx.TextCtrl.html
    "String input empty": ["str"],  # This will be a text input with an empty starting value
