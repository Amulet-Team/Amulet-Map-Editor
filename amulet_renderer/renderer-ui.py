...
class _MainWindow(wx.Frame):
    def __init__(self, parent):
        ...
        # region modify panel
        self.world_view_panel = wx.Panel(
            self.tab_holder,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        world_view_panel_sizer = wx.BoxSizer(wx.VERTICAL)

        main_sizer.Add(self.tab_holder, 1, wx.EXPAND | wx.ALL, 5)

        self.world_view_panel.SetSizer(world_view_panel_sizer)
        self.world_view_panel.Layout()
        world_view_panel_sizer.Fit(self.world_view_panel)
        self.tab_holder.AddPage(self.world_view_panel, "World 3D View", True)
